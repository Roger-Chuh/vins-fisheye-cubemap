...
public:
    ...
    virtual PointLineFeature trackImage(double _cur_time, cv::InputArray _img,
                                    cv::InputArray _img1 = cv::noArray()) override {};
...
//        cv::InputArray _img1)
    PointLineFeature PinholeFeatureTrackerCuda::trackImage(double _cur_time, cv::InputArray _img,
                                                       cv::InputArray _img1)
{
...
#else
    cv::Mat cur_gpu_img;
    _img.copyTo(cur_gpu_img);
    cv::Mat right_gpu_img;
    _img1.copyTo(right_gpu_img);
    ...
    pointLineFeature.featureFrame = featureFrame;
