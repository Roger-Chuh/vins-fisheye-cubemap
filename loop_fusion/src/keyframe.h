...
#define MIN_LOOP_NUM 15       // 10   // 15  // 25   // 15 // 25  // 15 // 25
...
public:
   ...
   // KeyFrame(double _time_stamp, int _index, Vector3d &_vio_T_w_i, Matrix3d &_vio_R_w_i, cv::Mat &_image,
     //        vector<cv::Point3f> &_point_3d, vector<cv::Point2f> &_point_2d_uv, vector<cv::Point3f> &_point_2d_normal,
       //      vector<double> &_point_id, int _sequence);
    ...
    //vector<cv::Point3f> point_2d_norm;
